...
class FAQScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(context, "FAQ"),
      body: const Column(
        children: [
          ToggleQuestion(
            question: 'Q: How do I create an AuroPay account?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: What payment methods does AuroPay support?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: How can I add funds to my AuroPay account?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: How do I make a payment using AuroPay?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: Is my personal and financial information secure with AuroPay?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: Can I transfer money internationally with AuroPay?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: How can I track my transaction history on AuroPay?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: What should I do if I encounter an issue or have a question related to AuroPay?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: Can I link multiple bank accounts or payment methods to my AuroPay account?',
            answer:
          ...
          ToggleQuestion(
            question: 'Q: Are there any fees associated with using AuroPay?',
            answer:
