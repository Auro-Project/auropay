      ...
      body: Center(
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Add functionality for Face ID here
                  // For example, you can add an onPressed callback to trigger Face ID authentication
                  // onPressed: () {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Add functionality for Touch ID here
                  // For example, you can add an onPressed callback to trigger Touch ID authentication
                  // onPressed: () {
                  //   // Implement Touch ID authentication logic here
                  // }
                ],
              ),
            ),
            ...
            const Text(
              'Choose the method by which it will be convenient for you to sign in',
              style: TextStyle(
                fontSize: 16,
